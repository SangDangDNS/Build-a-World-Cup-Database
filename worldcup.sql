...
--
-- Name: worldcup; Type: DATABASE; Schema: -; Owner: root
--

CREATE DATABASE worldcup WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';


ALTER DATABASE worldcup OWNER TO root;
...
--
-- Name: games_game_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
ALTER TABLE public.games_game_id_seq OWNER TO root;

--
-- Name: games_game_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: root
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
ALTER TABLE public.teams_team_id_seq OWNER TO root;

--
-- Name: teams_team_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: root
--
...
--
-- Name: games game_id; Type: DEFAULT; Schema: public; Owner: root
--
...
--
-- Name: teams team_id; Type: DEFAULT; Schema: public; Owner: root
--
...
--
-- Name: games_game_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: teams teams_name_key; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: games games_opponent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: games games_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--
